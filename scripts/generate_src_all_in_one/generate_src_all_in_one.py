...
def amalgamate_one_file(filename, already_included_local_files, already_included_external_files):
    ...
    separator_line = "//////////////////////////////////////////////////////////////////////////////////////////////////////////////////"
    filename_relative = filename.replace(REPO_DIR + "/", "")
    middle_line = f"//                       {filename_relative}".ljust(len(separator_line) - 2) + "//"
...
def amalgamate_cpp_files_content(folder, cpp_files: typing.List[str]):
    ...
    for cpp_file in cpp_files:
        content = content + amalgamate_one_file(folder + "/" + cpp_file, already_included_local_files, already_included_external_files) + "\n"
    return content
