...
macro(immvision_fetch_opencv_from_source)
    ...
    if (_existing_opencv_config)
        ...
        set(OpenCV_STATIC ON)  # normal variable too: see the note below
    else()
        ...
        set(OpenCV_STATIC ON CACHE BOOL "" FORCE)
        # Also set the normal variable: a previous failed find_package(OpenCV) on a Windows OpenCV pack
        # may have left a normal variable OpenCV_STATIC=OFF, which hides the cache value.
        ...
        if (NOT OpenCV_FOUND)
            ...
            if(WIN32 AND fetch_opencv)
                ...
                if(_bash_exe)
                    ...
                    message("Cannot build OpenCV from source: bash not found (it is provided by Git for Windows).")
                endif()
            elseif(fetch_opencv)
