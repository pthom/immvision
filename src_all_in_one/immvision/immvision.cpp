    ...
    namespace ImageNavigatorUtils
    {
        ...
        private:
            ...
            void UpdateLinkedZooms(const cv::Mat& image)
            {
                ...
                if (zoomKey.empty())
                    return;
                ZoomMatrix::ZoomMatrixType newZoom = currentCache.NavigatorParams->ZoomMatrix;
...
//                    ImVec2((float)params->ImageDisplaySize.width, (float)params->ImageDisplaySize.height));
            ...
            ImGui::Dummy(ImVec2((float)params->ImageDisplaySize.width, (float)params->ImageDisplaySize.height));
            cv::Point2d mouseLocation;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                       src/immvision/internal/gl_provider_python.cpp continued                                //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
