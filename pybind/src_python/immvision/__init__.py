...
class ColormapScaleFromStatsData(_cpp_immvision.ColormapScaleFromStatsData):
...
class ColormapSettingsData(_cpp_immvision.ColormapSettingsData):
    ...
    * internal_colormap_hovered: str = ""
    ...
    def __init__(
        ...
        _cpp_immvision.ColormapSettingsData.__init__(self)
        self.colormap = colormap
        self.colormap_scale_min = colormap_scale_min
        self.colormap_scale_max = colormap_scale_max
        self.colormap_scale_from_stats = colormap_scale_from_stats
