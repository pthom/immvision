...
def generate_docstring_python_code(struct_infos: StructInfos) -> str:
...
def main():
    ...
    generated_files = [
        ...
        AutoGeneratedFile("pybind/src_python/immvision/__init__.py", "docstring", generate_docstring_python_code),
