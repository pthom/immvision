...
def autogenerate_immvision():
    ...
    generated_files_structs = [
        code_generator.AutoGeneratedFile_StructInfos("pybind/src_cpp/pydef_image.cpp", "pydef_struct", code_generator.generate_pydef_struct_cpp_code),
        code_generator.AutoGeneratedFile_StructInfos("pybind/src_python/immvision/__init__.py", "init_struct", code_generator.generate_init_struct_python_code),
        code_generator.AutoGeneratedFile_StructInfos("pybind/src_python/immvision/_cpp_immvision.pyi", "pyi", code_generator.generate_pyi_python_code),
        code_generator.AutoGeneratedFile_StructInfos("src/immvision/internal/misc/immvision_to_string.cpp", "tostring", code_generator.generate_tostring_cpp_code),
        code_generator.AutoGeneratedFile_StructInfos("src/immvision/internal/misc/immvision_to_string.h", "tostring_decl", code_generator.generate_tostring_decl_h)
    ]
    ...
    for generated_file in generated_files_structs:
        ...
        for pydef_code_struct in pydef_codes_structs:
            struct_infos = code_generator.extract_struct_infos(pydef_code_struct)
