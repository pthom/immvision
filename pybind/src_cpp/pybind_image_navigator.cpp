...
void pydef_image_navigator(pybind11::module& m)
{
    ...
    auto pyClassImageNavigatorParams = py::class_<ImageNavigatorParams>(m, "ImageNavigatorParams", "Help on Params, maybe?")
        .def(py::init<>())
    ...
    auto c = py::class_<ColorAdjustmentsValues>(m, "ColorAdjustmentsValues")
        ...
        .def_readwrite("factor", &ColorAdjustmentsValues::Factor, "")
